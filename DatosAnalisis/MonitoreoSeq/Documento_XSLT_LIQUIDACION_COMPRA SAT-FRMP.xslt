									...
									<fo:table-cell border-width="0.5pt" text-align="left" padding="0pt">
										<fo:table table-layout="fixed" padding="0pt">
											...
											<fo:table-body>
												<!--LOGO-->
												<fo:table-row>
													<fo:table-cell text-align="center" padding="5pt">
														<fo:block>
															<fo:external-graphic src="url('{$logo1}')" width="100pt" height="100pt" />
														</fo:block>
													</fo:table-cell>
												</fo:table-row>
												<!--DatosPDF/Requerimiento SRI-->
												<fo:table-row>
													<fo:table-cell text-align="left" padding-top="45pt">
															...
															<fo:table-body>
																...
																<fo:table-row>
																	<fo:table-cell text-align="left" number-columns-spanned="3">
																		<fo:block>
																			<xsl:value-of select="DatosPDF/DtoEmisor/Nombre" />
																		</fo:block>
																	</fo:table-cell>
																</fo:table-row>
																<fo:table-row>
																...
																<!-- <fo:table-row> -->
																<!-- <fo:table-cell text-align="left" number-columns-spanned="2"> -->
																<!-- <fo:block>AGENTE DE RETENCION  NAC-DNCRASC20-00000001</fo:block> -->
																<!-- </fo:table-cell> -->
																<!-- <fo:table-cell text-align="left"> -->
																<!-- <fo:block> -->
																...
																<xsl:if test="DatosPDF/DtoInfoAdicionalEcuador/AgenteRetencion != ''">
																	<fo:table-row>
																		<fo:table-cell text-align="left" number-columns-spanned="3" font-weight="bold">
																			<fo:block>AGENTE DE RETENCION  NAC-DNCRASC20-0000000<xsl:value-of select="DatosPDF/DtoInfoAdicionalEcuador/AgenteRetencion" />
																			</fo:block>
																		</fo:table-cell>
																		<fo:table-cell text-align="left">
																			<fo:block />
																...
																<xsl:if test="DatosPDF/DtoInfoAdicionalEcuador/DescripcionTipoEmpresa = 'CONTRIBUYENTE RÉGIMEN MICROEMPRESAS'">
																	<fo:table-row>
																		<fo:table-cell text-align="left" number-columns-spanned="2" font-weight="bold">
																			<fo:block>
																				<xsl:value-of select="DatosPDF/DtoInfoAdicionalEcuador/DescripcionTipoEmpresa" />
																			</fo:block>
																		</fo:table-cell>
																		<fo:table-cell text-align="left">
																			<fo:block />
									...
									<fo:table-cell text-align="left" padding="0pt">
										<fo:table border-style="solid" border-width="0.1pt" table-layout="fixed" padding="6pt">
											...
											<fo:table-body font-size="8pt">
												...
												<fo:table-row>
													<!--Descripcion-->
													<fo:table-cell text-align="left" padding="2pt" font-weight="bold" padding-up="10pt">
									...
									<fo:table-cell border-width="0.5pt" padding="0.5pt" padding-top="0.5cm">
										<fo:table border-collapse="collapse" table-layout="fixed">
											...
											<fo:table-body font-size="6pt">
												...
												<xsl:for-each select="DatosPDF/Requerimiento/InformacionAdicional/Campo">
													<xsl:if test="Descripcion !='Contribuyente Régimen Microempresas' and Descripcion !='Agente de Retencion' and Descripcion !='Agente de Retención'">
														<fo:table-row>
															<!--Campo-->
															<fo:table-cell padding="0.5pt">
																<fo:block text-align="left">
													...
													<fo:table-row text-align="left">
														<fo:table-cell border-style="solid" border-width="0.1pt" padding="0.5pt" text-align="left" padding-top="0.1cm">
															<fo:block>
																...
																<xsl:if test="CodigoImpuesto='2' and CodigoPorcentaje='5'">									SUBTOTAL 5%								</xsl:if>
																<xsl:if test="CodigoImpuesto='2' and CodigoPorcentaje='4'">									SUBTOTAL 15%								</xsl:if>
												...
												<xsl:for-each select="DatosPDF/Requerimiento/Impuestos/Impuesto">
													<fo:table-row text-align="left">
														<xsl:choose>
															...
															<xsl:when test="CodigoImpuesto='2' and CodigoPorcentaje='4'">
																<fo:table-cell border-style="solid" border-width="0.1pt" padding="0.5pt" padding-top="0.1cm">
																	<fo:block>IVA 15%</fo:block>
																</fo:table-cell>
																<fo:table-cell border-style="solid" border-width="0.1pt" padding="0.5pt" text-align="right" padding-top="0.1cm">
																	<fo:block>
																		<xsl:value-of select="format-number(Valor,'###,##0.00')" />
															...
															<xsl:when test="CodigoImpuesto='2' and CodigoPorcentaje='5'">
																<fo:table-cell border-style="solid" border-width="0.1pt" padding="0.5pt" padding-top="0.1cm">
																	<fo:block>IVA 5%</fo:block>
																</fo:table-cell>
																<fo:table-cell border-style="solid" border-width="0.1pt" padding="0.5pt" text-align="right" padding-top="0.1cm">
																	<fo:block>
																		<xsl:value-of select="format-number(Valor,'###,##0.00')" />
									...
									<fo:table-row padding="2pt">
										<fo:table-cell padding-top="0.5cm">
											<fo:table border-collapse="collapse" table-layout="fixed">
												...
												<fo:table-column column-width="5cm" column-number="6" />
												<fo:table-body font-size="6pt" border-style="solid" border-width="0.1pt">
													<!--Cabecera-->
													<fo:table-row>
														<fo:table-cell padding="2pt" number-columns-spanned="6" font-weight="bold" font-size="7pt">
													...
													<fo:table-row>
														...
														<fo:table-cell text-align="center" font-weight="bold" padding-top="0.5pt" border-width="0.1pt" column-number="2">
															<fo:block padding="2pt">Pais Reembolso</fo:block>
														</fo:table-cell>
														...
														<fo:table-cell text-align="center" font-weight="bold" padding-top="0.5pt" border-width="0.1pt" column-number="6">
															<fo:block padding="2pt">Numero Autorización</fo:block>
														</fo:table-cell>
													</fo:table-row>
													<xsl:for-each select="DatosPDF/Requerimiento/DetallesReembolso/DetalleReembolso ">
														<fo:table-row>
															...
															<fo:table-cell text-align="center" padding-top="2pt" border-width="0.1pt" column-number="2">
																<fo:block padding="1pt">
																	<xsl:value-of select="CodPaisPagoProveedorReembolso" />
																</fo:block>
															</fo:table-cell>
															<fo:table-cell text-align="center" padding-top="2pt" border-width="0.1pt" column-number="3">
																<fo:block padding="1pt">
															...
															<fo:table-cell text-align="center" padding-top="2pt" column-number="4">
																<fo:block padding="1pt">
															...
															<fo:table-cell text-align="center" padding-top="2pt" border-width="0.1pt" column-number="6">
																<fo:block padding="1pt">
																	<xsl:value-of select="NumeroautorizacionDocReemb" />
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</xsl:for-each>
